This application works with the ESP32 microcontroller. This controller receives signals from BLE devices via Bluetooth Low Energy and transmits data to the phone via Bluetooth Classic.
